 ...
 * Merged from defaultUnits.ts and comprehensiveDefaults.ts
 *
 * This is the single source of truth for all built-in unit definitions.
 * Includes:
 * - Core SignalK spec paths (navigation, environment, etc.)
 * - Extended vessel data paths (design, propulsion, tanks, etc.)
 * - System metrics and sensors
 */
